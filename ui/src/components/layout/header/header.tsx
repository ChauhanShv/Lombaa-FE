...
import { FaBookmark, FaCommentDots, FaBell, FaList, FaSearch, FaHeart, FaMapMarkerAlt } from 'react-icons/fa';
import { Link } from 'react-router-dom';
import { Row, Col, Container, Navbar, Button, InputGroup, FormControl, Nav, NavDropdown, MenuItem, NavItem } from 'react-bootstrap';
