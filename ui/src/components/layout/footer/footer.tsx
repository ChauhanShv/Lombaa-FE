...
export const Footer: React.FC = () => {
    return (
        <>
            <section
                className="pt-4 pb-5 mt-0 align-items-end align-items-md-center d-flex bg-dark">
                    ...
                    <div className="container">
                        ...
                        <div className="col-md-4 text-xs-center   text-lg-right   my-1">
                            ...
                            <div className="mb-1 mr-3 align-self-right pt-0 d-inline-block">
                                ...
                                <i className="fab fa-twitter fa-lg color-light"
                                    aria-hidden="true"></i>
                                </a>
                                <a href="#" role="button"
                                ...
                                <i className="fab fa-google-plus fa-lg"
                                    aria-hidden="true"></i>
                                </a>
                            </div>
                            </div>
