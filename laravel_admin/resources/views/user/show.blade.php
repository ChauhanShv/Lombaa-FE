         ...
         <div class="tab-content clearfix">
            ...
            <div class="tab-pane" style="padding: 0px 35px;" id="4b">
               ...
               <div>
                  ...
                  <div>
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> User Name : {{$userPackage->user->email}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Package Name : {{$userPackage->packageName}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Package validity : {{$userPackage->package->validity}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Package price : {{$userPackage->package->price}} {{$userPackage->package->currency}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     @if($userPackage->category!== null)
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Category Name : {{$userPackage->category->name}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     @endif
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Package Start date : {{$userPackage->package->startDate}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                     <div class="control-group">
                        <label class="control-label" style="font-weight: bold;"> Package Expired date : {{$userPackage->endDate}}</label>
                        <lable class="span11" style="font-weight: bold"></lable>
                     </div>
                  </div>
                  @endforeach
